...
> <font color="red">**Note: A new version of the Kaltura Player SDK (V3) will be available for beta very soon. The new SDK will be fully native and will introduce significant performance improvements. 
If you are planning to begin a new project based on the SDK, you may want to wait for the new version.**</font>
